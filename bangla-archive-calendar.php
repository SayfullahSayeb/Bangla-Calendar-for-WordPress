 ...
 * Description: Bangla archive calendar for post filter.
 * Version: 1.0
 * Author: Sayfullah Sayeb
 * Author URI: https://github.com/SayfullahSayeb
 */
add_filter('plugin_row_meta', 'custom_plugin_row_meta', 10, 2); function custom_plugin_row_meta($links, $file) { if ($file == plugin_basename(__FILE__)) { $links[] = '<a href="https://github.com/SayfullahSayeb/Bangla-Calendar-for-WordPress" target="_blank">View Details</a>'; } return $links; }
...
add_shortcode('archive_calendar', 'archive_calendar_shortcode');
